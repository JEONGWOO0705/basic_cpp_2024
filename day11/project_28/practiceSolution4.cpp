...
int main() {
	...
	vector<Grade> gradeAry(num);	// 동적으로 배열을 할당할때는 벡터를 사용한다
	...
	cout << "국어 성적 총합 : " << kosum << "	국어 평균 : " << double(kosum / num) << endl;
	cout << "영어 성적 총합 : " << engsum << "	영어 평균 : " << double(engsum / num) << endl;
	cout << "수학 성적 총합 : " << mathsum << "	수학 평균 : " << double(mathsum / num) << endl;
